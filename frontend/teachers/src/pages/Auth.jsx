...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axiosInstance.post('/teacher/login',details)
            if(res.status==200){
        ...
        <>
            <div className='h-screen w-full flex items-center justify-center'>
                ...
                <div className='h-max md:w-[35%] w-[95%] px-6 py-9 shadow rounded-xl border border-borderPrimary'>
                    ...
                    <p className='font-primary mt-4 text-[14px] text-gray-700'> Welcome to Teacher Panel ! Please fill your details below to Login.</p>
