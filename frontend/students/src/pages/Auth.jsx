...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // console.log(details)
        try {
            const res = await axiosInstance.post('/alumini/login',details)
            if(res.status==200){
        ...
        <>
            <div className='h-[100vh] w-full flex items-center justify-center'>
                ...
                <div className='h-max md:w-[35%] w-[95%] px-6 py-9 shadow rounded-xl border border-borderPrimary'>
                    ...
                    <p className='font-primary mt-4 text-[14px] text-gray-700'> Welcome Student ! Please fill your details below to Login.</p>
